...
router.get('/overview', requireStaff, asyncHandler(async (req, res) => {
...
router.post('/config', requireOwner, asyncHandler(async (req, res) => {
...
router.get('/tickets', requireStaff, asyncHandler(async (req, res) => {
...
router.get('/tickets/stats/overview', requireStaff, asyncHandler(async (req, res) => {
...
router.get('/tickets/:ticketId', requireStaff, asyncHandler(async (req, res) => {
...
router.get('/tickets/:ticketId/transcript', requireStaff, asyncHandler(async (req, res) => {
  const ticketId = parseTicketId(req.params.ticketId);
  if (ticketId === null) return res.status(400).json({ error: 'Invalid ticket ID' });
  const ticket = await Ticket.findOne({ ticketId }).lean();
  if (!ticket) return res.status(404).json({ error: 'Ticket not found' });
...
router.get('/tickets/:ticketId/transcript/download', requireStaff, asyncHandler(async (req, res) => {
  const ticketId = parseTicketId(req.params.ticketId);
  if (ticketId === null) return res.status(400).json({ error: 'Invalid ticket ID' });
  const ticket = await Ticket.findOne({ ticketId }).lean();
  if (!ticket) return res.status(404).json({ error: 'Ticket not found' });
...
router.post('/tickets/:ticketId/close', requireStaff, asyncHandler(async (req, res) => {
  const ticketId = parseTicketId(req.params.ticketId);
  if (ticketId === null) return res.status(400).json({ error: 'Invalid ticket ID' });
...
router.get('/blacklists', requireStaff, asyncHandler(async (req, res) => {
...
router.delete('/blacklists/:id', requireOwner, asyncHandler(async (req, res) => {
...
router.post('/blacklists', requireOwner, asyncHandler(async (req, res) => {
...
router.get('/messages/:channelId', requireStaff, asyncHandler(async (req, res) => {
  if (!isDiscordId(req.params.channelId)) return res.status(400).json({ error: 'Invalid channel ID format' });
...
router.post('/messages/:channelId', requireStaff, asyncHandler(async (req, res) => {
  if (!isDiscordId(req.params.channelId)) return res.status(400).json({ error: 'Invalid channel ID format' });
...
router.patch('/messages/:channelId/:messageId', requireStaff, asyncHandler(async (req, res) => {
  if (!isDiscordId(req.params.channelId)) return res.status(400).json({ error: 'Invalid channel ID format' });
...
router.delete('/messages/:channelId/:messageId', requireStaff, asyncHandler(async (req, res) => {
  if (!isDiscordId(req.params.channelId)) return res.status(400).json({ error: 'Invalid channel ID format' });
  if (!isDiscordId(req.params.messageId)) return res.status(400).json({ error: 'Invalid message ID format' });
...
router.post('/messages/:channelId/embed', requireStaff, asyncHandler(async (req, res) => {
  if (!isDiscordId(req.params.channelId)) return res.status(400).json({ error: 'Invalid channel ID format' });
...
router.patch('/tickets/:ticketId', requireOwner, asyncHandler(async (req, res) => {
  const ticketId = parseTicketId(req.params.ticketId);
  if (ticketId === null) return res.status(400).json({ error: 'Invalid ticket ID' });
...
router.post('/tickets/:ticketId/participants', requireStaff, asyncHandler(async (req, res) => {
  const ticketId = parseTicketId(req.params.ticketId);
  if (ticketId === null) return res.status(400).json({ error: 'Invalid ticket ID' });
...
router.delete('/tickets/:ticketId/participants/:userId', requireStaff, asyncHandler(async (req, res) => {
  const ticketId = parseTicketId(req.params.ticketId);
  if (ticketId === null) return res.status(400).json({ error: 'Invalid ticket ID' });
...
router.patch('/blacklists/:id', requireOwner, asyncHandler(async (req, res) => {
  if (!isObjectId(req.params.id)) return res.status(400).json({ error: 'Invalid ID format' });
...
router.post('/commands/execute', requireOwner, asyncHandler(async (req, res) => {
...
router.get('/giveaways', requireStaff, asyncHandler(async (req, res) => {
...
router.post('/giveaways', requireOwner, asyncHandler(async (req, res) => {
...
router.post('/giveaways/:id/end', requireOwner, asyncHandler(async (req, res) => {
  if (!isObjectId(req.params.id)) return res.status(400).json({ error: 'Invalid ID format' });
...
router.post('/giveaways/:id/reroll', requireOwner, asyncHandler(async (req, res) => {
  if (!isObjectId(req.params.id)) return res.status(400).json({ error: 'Invalid ID format' });
  const giveaway = await Giveaway.findById(req.params.id);
  if (!giveaway) return res.status(404).json({ error: 'Giveaway not found' });
...
router.delete('/giveaways/:id', requireOwner, asyncHandler(async (req, res) => {
  if (!isObjectId(req.params.id)) return res.status(400).json({ error: 'Invalid ID format' });
...
router.post('/audit-logs', requireOwner, asyncHandler(async (req, res) => {
...
router.post('/users', requireOwner, asyncHandler(async (req, res) => {
...
router.patch('/users/:userId', requireOwner, asyncHandler(async (req, res) => {
...
router.delete('/users/:userId', requireOwner, asyncHandler(async (req, res) => {
  if (!isObjectId(req.params.userId)) return res.status(400).json({ error: 'Invalid user ID format' });
  const user = await DashboardUser.findById(req.params.userId);
  if (!user) return res.status(404).json({ error: 'User not found' });
